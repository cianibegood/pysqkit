...
arr_name = f"mixed_device_num_collisions_d_{DISTANCE}_resist_{MIN_RES_VAR}_{MAX_RES_VAR}_seeds_{NUM_SEEDS}_v3_{AMP_LABEL}_drive.nc"
...
with plt.rc_context(TEX_RC_PARAMS):
    fig, ax = plt.subplots(figsize=(3.39, 2.6189190273276797), constrained_layout=True)
