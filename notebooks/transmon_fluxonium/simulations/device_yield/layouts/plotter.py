"""
Module that implement the layout plotting.
"""
import re
...
def plot(
    ...
    *,
    ...
    label_qubits : bool, optional
        Whether to label the qubits in the plot, by default True
    axis : Optional[plt.Axes], optional
        The matplotlib axis on which to plot, by default None
...
class MatplotlibPlotter:
    ...
    def plot(
        ...
        """
        plot Plots the lattice.

        Parameters
        ----------
        label_qubits : bool, optional
            Whether to label the qubits in the plot, by default True
        draw_patches : bool, optional
            Whether to draw the stabilizer patches in the plot, by default True
        param_label : str, optional
            The parameter label to be used for the qubit lables, by default None
