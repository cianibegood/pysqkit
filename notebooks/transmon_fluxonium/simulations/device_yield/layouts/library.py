"""A library of lattice types  (in this case only the surface code)"""
...
def surface_code(distance: int, *, mixed_layout: Optional[bool] = True) -> Layout:
    """
    surface_code Returns a surface code lattice of a given distance.

    Parameters
    ----------
    distance : int
        The distance of the code.
    mixed_layout : Optional[bool], optional
        Whether both fluxonia and transmons are used as qubits for the layout, by default True.
        In this case the fluxonia are the ancilla qubits.
    ...
    ValueError
        If the distance is negative or an even number.
    """
